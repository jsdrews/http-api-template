...
class HealthApi(object):
    ...
    @validate_arguments
    def get_health(self, **kwargs) -> HealthCheck:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_health_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_health_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_health_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Server Health Check  # noqa: E501
